...
<html>
	...
	<body>		
		...
		<section>
			<div class = "section_title">홈쇼핑 회원 정보 수정</div>
			<div class = "section_info_update_content">
				<table border = "1">
					<tbody>
						<tr>
						...
						<tr>
							<td colspan = "2" style = "text-align : center">
								<button onclick = "_update()">수 정</button>
								<button onclick = "readCust()">조 회</button>
							</td>
						</tr>
					</tbody>
				</table>
		...
		<script src = "./js/info-update.js"></script>
		<script>readCust()</script>
	</body>
</html>